...
# Note that both the attached file and the code comments are in Chinese.
# 注意，本附件及代码注释均为中文
...
（The specific methodology can be found in the file “定标模型方法论.pdf”）

2 Quantitative Remote Sensing Estimation of Aboveground Biomass Based on Automated Feature Selection and Multi-Model Comparison
...
（The specific methodology can be found in the file “AGB建模的方法论.pdf”）

3 Temporal and Spatial Trend Analysis of Aboveground Biomass Based on Pixel-Level Linear Regression
...
（The specific methodology can be found in the file “时序分析的方法论.pdf”）
